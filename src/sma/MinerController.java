...
import static four.util.Communication.readNumMiners;
import static four.util.Communication.writeNumMiners;
import static sma.util.Communication.*;
import static sma.util.Exploration.minerExploreLoc;
import static sma.util.SafeActions.safeMine;
...
public class MinerController {
    ...
    static void runMiner(RobotController rc) throws GameActionException {
        ...
        // TODO: retreat can be improved bc what if backed into a wall
        if (isRetreating) {
            if (nearbyEnemies.length > 0) {

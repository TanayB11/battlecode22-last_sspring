...
import static five.util.Communication.getGoal;
import static five.util.Communication.reportEnemy;
import static five.util.Exploration.soldierExploreLoc;
import static five.util.Miscellaneous.*;
import static five.util.SafeActions.safeMove;


// TODO: Make a good micro.
// TODO: Replace the entire macro.
    ...
    static void runSoldier(RobotController rc) throws GameActionException {
        ...
        */
        ...
        // 1. Sense enemy to attack (target based on priority + low HP)
            // TODO: move into earlier if block with same signature
        ...
        if (targetEnemy != null && isAttackingUnit(targetEnemy.getType())) {
            ...
            // Non-attacking enemy, aggressively attack

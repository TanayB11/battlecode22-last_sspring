...
import kendrick.util.pathfinding.BFS;
import kendrick.util.pathfinding.DroidBFS;

import java.util.Arrays;

import static kendrick.util.Communication.*;
import static kendrick.util.Exploration.minerExploreLoc;
import static kendrick.util.Miscellaneous.ATTACK_PRIORITY_COMPARATOR;
import static kendrick.util.SafeActions.safeAttack;

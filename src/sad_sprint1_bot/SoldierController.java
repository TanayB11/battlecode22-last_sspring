...
//                indexCount++;
//                posDetected = (int) (rc.readSharedArray(4) / Math.pow(10, 4 - indexCount)) % 10;
//                break;
//            }
//        }

//        if (posDetected != 0) {
//            target = new MapLocation(posDetected / 100, posDetected % 100);
//            rc.setIndicatorString("found THE ARCHON " + target.toString() + " "+  Integer.toString(posDetected));
//        }
        ...
        // attack!
        toAttack = (enemies.length > 0) ? enemies[0].location : null;
